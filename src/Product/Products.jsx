...
export const Products = () => {
  ...
  const filterData = data.filter((productData) => {
    const categoryMatch =
      ...
      selectedCategories.includes(productData.productCategory);

    const priceChecked = priceRange.min !== 0 || priceRange.max !== Infinity;

    const priceMatch =
      (priceChecked &&
        productData.basePrice >= priceRange.min &&
        productData.basePrice <= priceRange.max) ||
      !priceChecked;
        ...
        <>
          <div className="error">
            <div className="error-state">
              <img
                src="https://media.istockphoto.com/id/1320496766/vector/no-wifi-area-sing-isolate-on-white-background-vector-illustration.jpg?s=612x612&w=0&k=20&c=DtWj62XGCHgKdp5i0akfxnbI4K8w0PsBKaef-7xt88s="
                alt="No internet"
              />
              <h3>
                          ...
                          <div key={i} className="sales">
                            ...
                            <div className="deals">
                              ...
                              <div className="name">
                                <h1>{product.name}</h1>
                                <p>
                                  <BsCurrencyDollar className="currency" />
                                  {`${product.basePrice}`}
                                </p>
